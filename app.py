...
if __name__ == '__main__':
    ...
    cam1 = Button(root, text="cam1", width=20, bg='red', fg='white', command=lambda num=1: click_cam(num))
    cam1.pack(padx=5, pady=5)
    cam2 = Button(root, text="cam2", width=20, bg='red', fg='white', command=lambda num=2: click_cam(num))
    cam2.pack(padx=5, pady=5)
    cam3 = Button(root, text="cam3", width=20, bg='red', fg='white', command=lambda num=3: click_cam(num))
